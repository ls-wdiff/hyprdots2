...
readonly SERVICES_CONFIG=(
    ...
    "$HOME/.config/hypr/scripts/waybar/network/network_meter.service | enable"

    # dusky sliders
    "$HOME//.config/hypr/scripts/sliders/service/dusky_sliders.service | disable"

    # dusky osd
    "$HOME/.config/hypr/scripts/mako_osd/osd_lock.service | enable"
)
